...
public class FIFOInc1 implements InitTemplate {
  ...
  public FIFOInc1() {
    throw new Error("Unresolved compilation problems:"
      ...
      + "\nThe field FIFOInc1.typeVertexSet refers to the missing type Vertex"
  ...
  public String create() {
    throw new Error("Unresolved compilation problems:"
      + "\nThe field FIFOInc1.typeVertexSet refers to the missing type Vertex"
      + "\nThe field FIFOInc1.typeVertexSet refers to the missing type Vertex"
      + "\nThe method foo(Vertex) from the type FIFOInc1 refers to the missing type Vertex");
  }
  ...
  public String foo(final /* Vertex */Object v) {
    throw new Error("Unresolved compilation problems:"
