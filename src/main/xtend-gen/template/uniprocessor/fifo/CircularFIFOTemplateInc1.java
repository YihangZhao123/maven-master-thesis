...
public class CircularFIFOTemplateInc1 implements InitTemplate {
  ...
  public String create() {
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("}ref_fifo;\t\t");
    _builder.newLine();
    _builder.append("\t");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("void ref_init(ref_fifo* fifo_ptr, void** buffer, size_t size);");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("void read_non_blocking(ref_fifo* fifo_ptr, void** dst);");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("void write_non_blocking(ref_fifo* fifo_ptr, void* src);\t\t");
    _builder.newLine();
    _builder.append("\t");
    _builder.newLine();
    _builder.append("\t");
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("size_t token_number;");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("size_t token_size;");
    _builder.newLine();
    _builder.append("\t");
    _builder.newLine();
    _builder.append("}copy_fifo;");
    _builder.newLine();
    _builder.append("void init2(copy_fifo* fifo_ptr, void* buf, size_t token_number, size_t token_size);");
    _builder.newLine();
    _builder.append("void read_non_blocking2(copy_fifo* fifo_ptr,void* dst);");
    _builder.newLine();
    _builder.append("void write_non_blocking2(copy_fifo* fifo_ptr,void* src);\t\t\t");
    _builder.newLine();
    {
