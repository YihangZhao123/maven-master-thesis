...
public class CircularFIFOTemplateSrc1 implements InitTemplate {
  ...
  public String create() {
    ...
    _builder.append("}");
    _builder.newLine();
    _builder.append("void write_non_blocking(ref_fifo* channel, void* src){");
    _builder.newLine();
    _builder.append("    ");
    ...
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("memcpy(channel->rear*channel->token_size+channel->buffer, src , channel->token_size);");
    _builder.newLine();
    _builder.append("\t\t ");
